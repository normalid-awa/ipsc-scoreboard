...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./assets/_tanstack-start-manifest_v-CnPZgiOr.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./assets/_tanstack-start-server-fn-manifest_v-DmHzHeNn.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-ChsquRSI.js").then((n) => n.r);
    }
    if (startEntry === null) {
