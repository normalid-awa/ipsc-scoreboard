		...
		<>
			<Stack>
				...
				>
					...
					<AccordionDetails>
						<Stack component={"form"} spacing={2} onSubmit={emailSignUp}>
							...
							<FormControl required>
								...
								<OutlinedInput
									...
									type="text"
								/>
								<FormHelperText>In which you use to sign in</FormHelperText>
							</FormControl>
							<FormControl required>
								...
								<OutlinedInput
									...
									type="text"
								/>
								<FormHelperText>In which others sees you</FormHelperText>
							</FormControl>
							<TextField
								required
