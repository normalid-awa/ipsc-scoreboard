					...
					<TransitionGroup>
						{reversedTimings.length === 0 ? (
							<Paper variant="outlined" sx={{ p: 2 }}>
								<Typography textAlign={"center"}>No record</Typography>
							</Paper>
						) : (
							<></>
						)}
								...
								<Paper variant="outlined">
									<ListItemButton>
										...
										<ListItemText
											...
											secondary={`Split: ${(i == reversedTimings.length - 1
												? 0
												: reversedTimings[i] - reversedTimings[i + 1]
											).toFixed(2)}s`}
										/>
									</ListItemButton>
								</Paper>
...
export default function Timer() {
	...
	return (
		<>
			<TimerMenuDialog open={menuOpen} onClose={() => setMenuOpen(false)} />
